...
class LiveMatchService @Inject constructor(
    ...
    private fun handleMatchEvent(event: com.score24seven.data.websocket.MatchEvent) {
    ...
    private fun handleScoreUpdate(update: com.score24seven.data.websocket.ScoreUpdate) {
        Log.d(TAG, "Processing score update for match ${update.matchId}: ${update.homeScore}-${update.awayScore}")
    }

    private fun handleStatusUpdate(update: com.score24seven.data.websocket.StatusUpdate) {
