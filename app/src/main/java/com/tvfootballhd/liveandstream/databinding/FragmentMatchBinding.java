...
public final class FragmentMatchBinding implements ViewBinding {
    ...
    private FragmentMatchBinding(FrameLayout frameLayout, View view, RelativeLayout relativeLayout, LottieAnimationView lottieAnimationView, ImageView imageView, ViewPager viewPager, TabLayout tabLayout2) {
                ...
                if (lottieAnimationView != null) {
                    ...
                    if (imageView != null) {
                        ...
                        if (viewPager != null) {
                            ...
                            if (tabLayout2 != null) {
                                return new FragmentMatchBinding((FrameLayout) view, findChildViewById, relativeLayout, lottieAnimationView, imageView, viewPager, tabLayout2);
                            }
                        }
                    }
                }
