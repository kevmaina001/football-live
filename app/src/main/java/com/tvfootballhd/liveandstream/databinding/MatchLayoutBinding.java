...
public final class MatchLayoutBinding implements ViewBinding {
    ...
    private MatchLayoutBinding(CardView cardView, TextView textView, TextView textView2, TextView textView3, ImageView imageView, TextView textView4, ImageView imageView2, TextView textView5, ImageView imageView3, LinearLayout linearLayout, TextView textView6) {
                                ...
                                if (textView5 != null) {
                                    ...
                                    if (imageView3 != null) {
                                        ...
                                        if (linearLayout != null) {
                                            ...
                                            if (textView6 != null) {
                                                return new MatchLayoutBinding((CardView) view, textView, textView2, textView3, imageView, textView4, imageView2, textView5, imageView3, linearLayout, textView6);
                                            }
                                        }
                                    }
                                }
