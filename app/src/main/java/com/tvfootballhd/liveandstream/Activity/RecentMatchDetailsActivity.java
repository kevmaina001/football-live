...
public class RecentMatchDetailsActivity extends AppCompatActivity {
    ...
    private LastFiftyMatches.Response response;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_recent_match_details);
        this.response = (LastFiftyMatches.Response) getIntent().getSerializableExtra("FixtureResponseClass");
        ...
        if (this.currentTime > time) {
            ...
            new CountDownTimer(this.matchTime - this.currentTime, 1000) {
                public void onFinish() {
                }

                public void onTick(long j) {
                    long j2 = j / 1000;
                    TextView access$000 = RecentMatchDetailsActivity.this.goalTV;
                    access$000.setText((j2 / 3600) + ":" + ((j2 % 3600) / 60) + ":" + (j2 % 60));
                }
            }.start();
        }
        ...
        tabLayout2.addTab(tabLayout2.newTab().setText((CharSequence) "Head To Head"));
        TabLayout tabLayout3 = this.tabLayout;
        tabLayout3.addTab(tabLayout3.newTab().setText((CharSequence) "Standing"));
        TabLayout tabLayout4 = this.tabLayout;
        tabLayout4.addTab(tabLayout4.newTab().setText((CharSequence) "Matches"));
        TabLayout tabLayout5 = this.tabLayout;
        tabLayout5.addTab(tabLayout5.newTab().setText((CharSequence) "Line Up"));
        TabLayout tabLayout6 = this.tabLayout;
        tabLayout6.addTab(tabLayout6.newTab().setText((CharSequence) "Team States"));
        ...
        this.tabLayout.setOnTabSelectedListener((TabLayout.OnTabSelectedListener) new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                RecentMatchDetailsActivity.this.viewPager.setCurrentItem(tab.getPosition());
            }
        });
