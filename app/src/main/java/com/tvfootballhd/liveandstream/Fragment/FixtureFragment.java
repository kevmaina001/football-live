...
import com.tvfootballhd.liveandstream.Adapter.TeamMatchAdapter;
        ...
        Volley.newRequestQueue(getContext()).add(new CacheRequest(0, "https://api-football-v1.p.rapidapi.com/v3/fixtures?season=" + this.seasonId + "&team=" + this.id, new Response.Listener<NetworkResponse>() {
            public void onResponse(NetworkResponse networkResponse) {
                try {
                    ...
                    InfoResponse unused = FixtureFragment.this.infoResponse = (InfoResponse) new Gson().fromJson(jSONObject.toString(), InfoResponse.class);
