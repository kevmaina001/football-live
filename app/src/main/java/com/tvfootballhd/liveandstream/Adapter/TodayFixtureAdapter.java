...
public class TodayFixtureAdapter extends RecyclerView.Adapter<TodayFixtureAdapter.TodayFixtureAdapterHolder> {
    ...
    public TodayFixtureAdapter(Context context2, ArrayList<FixtureResponse.Response> arrayList) {
    ...
    public void onBindViewHolder(TodayFixtureAdapterHolder todayFixtureAdapterHolder, int i) {
        ...
        if (checkNotificationSelected(response.getFixture().getId())) {
            ...
            todayFixtureAdapterHolder.notificationIcon.setImageDrawable(this.context.getResources().getDrawable(R.drawable.baseline_notifications2));
        }
    }
    ...
    public class TodayFixtureAdapterHolder extends RecyclerView.ViewHolder {
        ...
        public TodayFixtureAdapterHolder(View view, OnclickListener onclickListener, NotificationItemClickListener notificationItemClickListener) {
            ...
            this.notificationIcon = (ImageView) view.findViewById(R.id.notificationIconId);
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    fixtureResponseClass(view);
                }
            });
            this.notificationIcon.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
        ...
        public void fixtureResponseClass(View view) {
            Intent intent = new Intent(TodayFixtureAdapter.this.context, ScheduleDetailsActivity.class);
